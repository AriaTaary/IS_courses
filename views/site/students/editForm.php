                    ...
                    <div class="login-form">
                        ...
                        <select name="gender_id" id="">
                            <?php foreach ($genders as $gender) : ?>
                                <option value="<?= $gender['id'] ?>" <?php if ($data['gender_id'] == $gender['id']) : ?>selected<?php endif; ?>><?= $gender['name'] ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="login-form">
                        ...
                        <select name="group_id" id="">
                            <?php foreach ($groups as $group) : ?>
                                <option value="<?= $group['id'] ?>" <?php if ($data['group_id'] == $group['id']) : ?>selected<?php endif; ?>><?= $group['number'] ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="login-form">
                        ...
                        <select name="payment_id" id="">
                            <?php foreach ($payment_status as $payment) : ?>
                                <option value="<?= $payment['id'] ?>" <?php if ($data['payment_id'] == $payment['id']) : ?>selected<?php endif; ?>><?= $payment['name'] ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
